...
export const USER_PACKAGES_LIST_TABLE_CLASS = [
  "max-md:space-y-3",
  "md:grid",
  "md:grid-cols-[minmax(0,11rem)_minmax(8rem,auto)_minmax(9rem,auto)_minmax(9.5rem,auto)_minmax(6.5rem,auto)_1fr_auto]",
  USER_LIST_TABLE_GRID_GAP,
  "md:gap-y-3",
].join(" ");
...
export {
  USER_LIST_ACTIONS_CELL as USER_PACKAGES_LIST_ACTIONS_CLASS,
