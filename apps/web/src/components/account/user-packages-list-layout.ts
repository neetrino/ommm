...
export const USER_PACKAGES_LIST_STATUS_CELL = USER_LIST_STATUS_CELL;

export const USER_PACKAGES_LIST_ACTIONS_CELL = USER_LIST_ACTIONS_CELL;

export const USER_PACKAGES_LIST_ACTIONS_HEADER_CELL = USER_LIST_TRAILING_HEADER_CELL;

export {
  USER_LIST_CELL_CLASS as USER_PACKAGES_LIST_CELL_CLASS,
  USER_LIST_CELL_CLASS as USER_PACKAGES_LIST_ITEM_CELL,
  USER_LIST_SPACER_CELL as USER_PACKAGES_LIST_SPACER_CELL,
};
