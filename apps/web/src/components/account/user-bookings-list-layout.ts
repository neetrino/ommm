...
export const USER_BOOKINGS_LIST_TABLE_CLASS = [
  "max-md:space-y-3",
  "md:grid",
...
export {
  USER_LIST_ACTIONS_CELL as USER_BOOKINGS_LIST_ACTIONS_CELL,
...
export const USER_BOOKINGS_LIST_STATUS_CELL = [
  USER_LIST_CELL_CLASS,
  "md:flex md:items-center",
].join(" ");

export const USER_BOOKINGS_LIST_ACTIONS_HEADER_CELL = USER_LIST_TRAILING_HEADER_CELL;
