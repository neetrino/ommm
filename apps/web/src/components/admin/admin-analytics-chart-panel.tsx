...
export function AdminAnalyticsChartPanel({
  ...
  return (
    <section className="min-w-0 max-w-full overflow-x-auto overscroll-x-contain rounded-[24px] border border-white/60 bg-white/55 p-4 shadow-[0_12px_32px_-24px_rgba(45,40,35,0.22)] backdrop-blur-md sm:p-5">
