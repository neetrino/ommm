...
const kpiCapsuleClass =
  "min-w-0 max-w-full overflow-x-clip rounded-[20px] border border-white/60 bg-white/65 px-3 py-2.5 shadow-[0_8px_24px_-20px_rgba(45,40,35,0.2)] backdrop-blur-md";
...
export function AdminDashboardKpiHero({
  ...
  return (
    <section className="min-w-0 max-w-full overflow-x-clip rounded-[24px] border border-white/50 bg-white/35 p-3 shadow-[0_12px_32px_-24px_rgba(45,40,35,0.18)] backdrop-blur-md sm:p-4">
