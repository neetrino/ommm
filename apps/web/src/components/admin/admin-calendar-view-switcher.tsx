...
const VIEW_MODES: readonly AdminCalendarView[] = ["list", "weekly", "monthly", "daily"];

const CALENDAR_VIEW_LETTERS: Partial<Record<AdminCalendarView, string>> = {
  weekly: "W",
  monthly: "M",
  daily: "Y",
};
...
export type AdminCalendarViewLabels = {
  groupAria: string;
  list: string;
  monthly: string;
  weekly: string;
