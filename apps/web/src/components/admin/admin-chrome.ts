...
export const adminChrome = {
  ...
  tableWrap:
    "w-full max-w-full min-w-0 overflow-x-auto overscroll-x-contain rounded-[24px] border border-white/60 bg-white/55 shadow-[0_12px_32px_-24px_rgba(45,40,35,0.22)] backdrop-blur-md",
