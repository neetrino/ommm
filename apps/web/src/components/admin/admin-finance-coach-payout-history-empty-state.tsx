...
/** Centered empty panel for coach payout history when no paid rows match filters. */
export function AdminFinanceCoachPayoutHistoryEmptyState() {
    ...
    >
      ...
      >
        <span className="mx-auto flex h-14 w-14 items-center justify-center rounded-full border border-white/70 bg-white/80 text-sage-600 shadow-[inset_0_1px_0_rgb(255_255_255_/_0.9)]">
          <AdminNavIcon slug="finance" className="h-6 w-6" />
        </span>
