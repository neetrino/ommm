...
/**
 * Member hard navigation remounts the document (to bypass intercept routes),
 * which would kill the olive pill layout animation. Hold the pending href so the
 * thumb can slide first, then assign location after the pill tween.
 */
