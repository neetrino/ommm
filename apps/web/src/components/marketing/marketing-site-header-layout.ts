...
export const MARKETING_MOBILE_HEADER = {
  ...
  menuEdgeNudgePx: 4,
  globeIconSizePx: 26,
  /** Header profile avatar — same size as globe/action icons. */
  avatarInsetPx: 0,
  userIconWidthPx: 24,
  userIconHeightPx: 24,
