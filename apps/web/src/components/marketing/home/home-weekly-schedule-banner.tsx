...
import { HOME_HERO_LAYOUT } from "@/components/marketing/home/home-hero-banner-tokens";
import {
...
export async function HomeWeeklyScheduleBanner({ locale }: HomeWeeklyScheduleBannerProps) {
  ...
  return (
    <section
      ...
      className={`${marketingMontserrat.variable} relative z-10 w-full min-w-0 px-4 pb-8 sm:px-6 sm:pb-10 md:px-10 md:pb-12 lg:px-20`}
      style={{ marginTop: `calc(-1 * ${HOME_HERO_LAYOUT.heroPanelOverlap})` }}
    >
      <div className="mx-auto w-full max-w-[90rem]">
        <div
          className="w-full overflow-hidden px-4 py-10 sm:px-8 sm:py-12 md:px-12 md:py-14"
          style={{
            backgroundColor: HOME_WEEKLY_SCHEDULE_FIGMA.panelFill,
            borderRadius: HOME_WEEKLY_SCHEDULE_FIGMA.panelRadiusPx,
          }}
        >
          <header className="mx-auto flex max-w-[52rem] flex-col items-center gap-6 text-center">
            <h2
            ...
            <p
              ...
              className={`${marketingMontserrat.className} max-w-[32.875rem] text-base font-normal leading-[1.6] tracking-[0.01em]`}
