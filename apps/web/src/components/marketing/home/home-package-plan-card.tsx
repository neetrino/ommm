...
function planCardStyleVars(): CSSProperties {
  return {
    ...
    ["--home-plan-category-max-width" as string]: `calc(100% - ${HOME_PLANS_SECTION_LAYOUT.categoryCornerInsetX} - 1rem)`,
    ["--home-plan-category-size" as string]: `${HOME_PLANS_SECTION_LAYOUT.categoryFontSizePx}px`,
