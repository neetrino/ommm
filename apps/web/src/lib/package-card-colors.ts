/**
 * Deterministic wellness palette for public package category cards.
 * Original Figma tones first, then extended studio-friendly pastels.
 */
...
/** Stable hash for palette index — same category key always maps to the same preferred color. */
...
/**
 * Picks a gradient start color for one category card.
 * When the preferred color matches the previous card, advances to the next palette slot.
 */
...
/** Assigns gradient start colors for an ordered list of category keys (adjacent dedup). */
