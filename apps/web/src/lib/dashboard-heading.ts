...
const SUBTITLE_BY_HREF: Partial<Record<string, string>> = {
  ...
  "/admin/profile":
    "Your backoffice identity, sign-in email, and workspace integration notes.",
  ...
  "/user/profile":
    "Your member details, password, home image, and notification preferences.",
  ...
  "/coach/profile": "Your coach identity, account summary, and workspace notes.",
  ...
  "/manager/profile": "Your manager account summary and operational guidance.",
