...
export function useScheduleCopy() {
  ...
  return useMemo(
    () => ({
      ...
      fullCalendar: t("fullCalendar"),
      fullCalendarAria: t("fullCalendarAria"),
      calendarPrevMonthAria: t("calendarPrevMonthAria"),
      calendarNextMonthAria: t("calendarNextMonthAria"),
      intlLocale,
