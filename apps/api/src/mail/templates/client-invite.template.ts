...
<table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 0 24px;">
  <tr>
    <td align="center" style="border-radius:999px;background:${EMAIL_BRAND.accentColor};">
      <a href="${escapeHtml(setupUrl)}" style="display:inline-block;padding:14px 28px;font-family:${EMAIL_BRAND.sansFontFamily};font-size:15px;font-weight:600;line-height:1.2;color:#ffffff;text-decoration:none;">
...
<p style="margin:0 0 24px;font-family:${EMAIL_BRAND.sansFontFamily};font-size:13px;line-height:1.55;word-break:break-all;">
  <a href="${escapeHtml(setupUrl)}" style="color:${EMAIL_BRAND.accentColor};text-decoration:none;">${escapeHtml(setupUrl)}</a>
</p>
