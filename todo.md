...
## Фаза 2 — гостевой пропуск

Отдельный продукт, не «гость в каталоге».

- [ ] Слот гостевого пропуска на купленном пакете
- [ ] Владелец бронирует гостя без списания своего занятия
- [ ] Персонал видит, что пропуск уже использован

---

## Фаза 3 — заморозка

- [ ] Включить freeze на тарифах (Packages → Edit: `freezeAllowedCount` / `freezeMaxDaysPerUse`)
- [ ] Админ может заморозить пакет даже если на тарифе freeze = 0
